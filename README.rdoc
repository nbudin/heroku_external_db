...
This may still be useful to you if for example you want to have feature toggles in a local database, but the main data kept externally.

  # See http://devcenter.heroku.com/articles/database
  # TODO maybe heroku config:remove DATABASE_URL

With your gems updated, we commit:
...
Open http://yourapp.heroku.com and we should see our data.  If you are not in your situation, please check the logs first:
